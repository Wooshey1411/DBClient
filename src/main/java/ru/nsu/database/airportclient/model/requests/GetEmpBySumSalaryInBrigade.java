...
public class GetEmpBySumSalaryInBrigade implements IRequest {
    ...
    public final static List<String> CONDITIONS = Arrays.asList(
            "e.Brigade_id IN (SELECT ss.Brigade_id FROM All_brigades_sum_salary ss WHERE ss.Sum_salary >= ?)"
    );
    ...
    public static String ALIAS = "Работники по суммарной зарплате в бригаде";
