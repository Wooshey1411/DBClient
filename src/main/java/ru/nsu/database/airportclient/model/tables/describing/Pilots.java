...
public class Pilots implements ITable {

    public final static String TABLE_NAME = "pilots";

    public final static String TABLE_NAME_ALIAS = "Пилоты";
    public final static List<Token> TOKENS = Arrays.asList(
            new Token("pilot_id", true, TokenType.INTEGER, null, false, true, "Идентификатор"),
            new Token("pilot_rank", false, TokenType.INTEGER, null, true, true, "Ранг")
    );
    ...
    public final static List<LinkedToken> ADD_TOKENS = Arrays.asList(
            ...
            new LinkedToken("pilot_rank","Ранг", false, TokenType.INTEGER, 0, null, null)
    );
    ...
    public String getRequestForGetData() {
        return "select pilot_id, emp_firstname, emp_lastname, emp_fathername, emp_passport, emp_salary, pilot_rank" +
                " from pilots left join employees e on e.emp_id = pilots.pilot_id";
    }
    ...
    public String getSQLForUpdate() {
        return "update pilots set pilot_rank = ? where pilot_id = ?";
    }
