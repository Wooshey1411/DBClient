...
public class GetFreePlacesOnFlight implements IRequest {
    ...
    public static String ALIAS = "Свободные места";
    ...
    public String getRequestBody() {
        return "select ticket_place, flight_code, leave_time, arrival_time from (select * from timetable join public.tickets\n" +
                " t on timetable.timetable_id = t.ticket_flight_id join public.flights f on f.flight_id = timetable.flight_id where t.ticket_passanger_id is null)\n";
    }
